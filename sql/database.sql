...
ALTER TABLE `pingpong`.`usuario_pregunta` 
ADD COLUMN `cantidadAciertos` INT NULL AFTER `idPregunta`,
ADD COLUMN `cantidadApariciones` INT NULL AFTER `cantidadAciertos`;
